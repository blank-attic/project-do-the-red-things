=== Calendar by TS – Responsive Event Calendar for WordPress ===
...
Events Calendar plugin created for showing your events. Total Soft Calendar is the best if you want to be original on your website.

== Description ==

Events Calendar is a flexible plugin that allows you to connect to your database and show up your event days on a view. The plugin can render a Day, Week, Month and Resource calendar view. The also provides an interface for manipulating and formatting dates and times. Each event box has a link to the original event you defined in your calendar.

### Fully responsive
Total-Soft Events Calendar is designed to be shown clearly and neatly on any screen size. No matter how small your device screens are, it will automatically adjust to fit on that screens and display perfectly.

*  [Buy Events Calendar Pro](http://total-soft.pe.hu/calendar-event/)
*  [The Events Calendar FAQ](http://total-soft.pe.hu/calendar-event-faq/)
*  [The Events Calendar User Manual](http://total-soft.pe.hu/calendar-event-user-manual/)
*  [The Events Calendar Support](https://wordpress.org/support/plugin/calendar-event)

> Event Calendar Live Demos.
> 
>[Green Event Calendar Demo Version](http://total-soft.pe.hu/calendar-event-1/) | [Green Event Calendar Demo Version](http://total-soft.pe.hu/calendar-event-2) | [Green Event Calendar Demo Version](http://total-soft.pe.hu/calendar-event-3/)
>
...
* [Best Poll](https://wordpress.org/plugins/poll-wp/ "Best Poll Plugin") - Poll plugin is a responsive and customizable for WordPress. Poll plugin will help you more easily create powerful poll, quiz, vote results and simple dashboard. You Can from admin panel see who voted and from where.
...
*  You can add videos (YouTube and Vimeo) to the events (all calendar types)
*  You can add photos to the events (all calendar types)
...
* **Event Image/Video** - You can give a Image and Video(YouTube and Vimeo) for event. Event Image and Video option is available for all calendar types.

### Main features of Calendar.

- **Pro version** - This opens up new useful functions and new possibilities.

- **Support** - If you use Total Soft calendar plugin and have problems or conflicts with other plugins and themes, do not forget to contact our support team by e-mail: totalsoft.team@gmail.com or feel free to open a support [ticket in the WordPress](https://wordpress.org/support/plugin/calendar-event)
...
- **AJAX Support** - Total Event Calendar supports AJAX, which allows users to browse the calendar by event, day, week, month or year without ever refreshing the screen page.
...
- **Event Calendar Link** - There is a special place for adding a Link to each event in the calendar. Choose to open the Link in the new tab or not.

Events Plugin has his own ID number. Simply you must copy it and paste to that place, where you want to see your calendar plugin.
...
>Technical Support
>If You have notice any errors or have any questions in our WordPress Event Calendar, You can notify us about that. We will investigate and solve the problem. Please, contact to us by this address: totalsoft.team@gmail.com or feel free to open a support [ticket in the WordPress](https://wordpress.org/support/plugin/calendar-event).
...
* You can contact with our [Support team](mailto:totalsoft.team@gmail.com) or feel free to open a support [ticket in the WordPress](https://wordpress.org/support/plugin/calendar-event), They will help you to quickly install a calendar plugin.
* We are always ready to help everyone.

4). How to get an updated version?

* Pro users can get updated version of the plugin contacting with us at the following [Email] (mailto:totalsoft.team@gmail.com) or feel free to open a support [ticket in the WordPress](https://wordpress.org/support/plugin/calendar-event). As long as it's given for plugin Pro versions.
...
* If you make a purchase and haven't received Event-Calendar.zip file, or you just got and it have some problem, contact us on our Email address totalsoft.team@gmail.comor feel free to open a support [ticket in the WordPress](https://wordpress.org/support/plugin/calendar-event). Please send us the order number which you received after purchasing. We will check it and send you directly.
...
10.) How can I add plugin in widget?
...
* A fully featured [event calendar demo](http://total-soft.pe.hu/calendar-event-1/) is now available.
...
### Event Calendar Demonstration - Step by step guide.
...
> - Weekday Color - Select the calendar text color for the weekdays.
> - Weekday Font Size - Set the calendar text size for the weekdays.
> - Weekday Font Family - Choose the font family of the weekdays.
...
> - Todays Color - Choose the date color, that will be displayed.
> - Todays Size - Set the size of the numbers by pixels.
...
> - Event Day's Color - Select the event color for days
> - Event Day's Hover Color - Select the event hover color for days
...
> - Support - If you use Total Soft plugin and have problems or conflicts with other plugins and themes, do not forget to contact our support team by e-mail: totalsoft.team@gmail.com or feel free to open a support [ticket in the WordPress](https://wordpress.org/support/plugin/calendar-event)
...
### Technical Support
**If You have notice any errors or have any questions in our WordPress plugin, You can notify us about that. We will investigate and solve the problem. Please, contact to us by this address: totalsoft.team@gmail.com or feel free to open a support [ticket in the WordPress](https://wordpress.org/support/plugin/calendar-event)**