<?php
	...
	require_once('Total-Soft-Calendar-Check.php');
?>
	...
	<table class="Total_Soft_AMOTable">
	 	<?php for($i=0;$i<count($TotalSoftCalCount);$i++){
	 		...
	 		<tr>
				...
				<td onclick="TotalSoftCal_Clone(<?php echo $TotalSoftCalCount[$i]->id;?>)"><i class="Total_Soft_icon totalsoft totalsoft-file-text"></i></td>
